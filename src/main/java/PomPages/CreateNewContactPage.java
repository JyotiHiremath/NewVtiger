...
public class CreateNewContactPage {
	...
	@FindBy(name="salutationtype") private WebElement saluatationdropDown;
	...
	@FindBy(xpath="/div[@id='ListViewContents']/descendant::table[@cellpadding='5']/descendant::tr/td[1]/a") private List<WebElement> organizationsList;
	...
	public void selectSalutation(WebDriverUtility web, String Value) {
		web.dropdown(Value, saluatationdropDown);
